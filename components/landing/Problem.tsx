      ...
      <div className="container-shell">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-24">
          <RevealUp className="lg:col-span-5">
            ...
            <h2 className="text-display-sm text-carbon">
          ...
          <RevealUp delay={1} className="lg:col-span-7">
            <div className="font-body-editorial flex flex-col gap-8 text-[17px] leading-relaxed text-carbon">
              <p>
              ...
              <div className="border-l border-fog pl-6 text-graphite lg:pl-10">
                <p>
                  ...
                  the top 1% with a full-time manager. <strong className="text-carbon">Free, always, no cut of your deals.</strong>
                </p>
              </div>
            </div>
          </RevealUp>
