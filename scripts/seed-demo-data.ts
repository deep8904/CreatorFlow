...
async function seed(userId: string) {
  ...
  const deals = [
    { brand_name: 'Aura Skincare', contact_name: 'Priya Nair', contact_email: 'priya@aurabeauty.co', status: 'inbound', rate_amount_cents: 150000, deliverables: '1 dedicated YouTube video', notes: 'Reached out after seeing the desk setup video.', created_at: daysAgo(1) },
    { brand_name: 'Northstar VPN', contact_name: 'Alex Kim', contact_email: 'partnerships@northstarvpn.com', status: 'inbound', rate_amount_cents: 80000, deliverables: '60-second mid-roll ad read', created_at: daysAgo(2) },
    { brand_name: 'Bloom Meal Kits', contact_name: 'Sasha Winters', contact_email: 'sasha@bloommeals.com', status: 'inbound', rate_amount_cents: 120000, deliverables: '1 integration + 1 Story post', notes: 'Wants a 2-video series if the first goes well.', created_at: daysAgo(3) },
    { brand_name: 'Kinetic Audio', contact_name: 'Marcus Webb', contact_email: 'marcus@kineticaudio.io', status: 'inbound', rate_amount_cents: 95000, deliverables: 'Unboxing + review video', created_at: daysAgo(5) },
    { brand_name: 'Trailmix Gear', contact_name: 'Dana Osei', contact_email: 'dana@trailmixgear.com', status: 'inbound', rate_amount_cents: 60000, deliverables: '1 dedicated Short', notes: 'Smaller budget but good brand fit.', created_at: daysAgo(6) },
    { brand_name: 'Formfit Athletics', contact_name: 'Jordan Reyes', contact_email: 'jordan@formfit.com', status: 'negotiating', rate_amount_cents: 220000, deliverables: '2 videos + 3 Shorts', notes: 'Countered their first offer, waiting on revised terms.', due_date: daysFromNow(12), created_at: daysAgo(10) },
    { brand_name: 'Verve Energy Drinks', contact_name: 'Casey Lin', contact_email: 'casey@verveenergy.com', status: 'negotiating', rate_amount_cents: 175000, deliverables: '1 video + usage rights (90 days)', notes: 'They want paid social usage rights, discussing add-on fee.', due_date: daysFromNow(9), created_at: daysAgo(9) },
    { brand_name: 'Lumen Desk Co.', contact_name: 'Rina Suzuki', contact_email: 'rina@lumendesk.com', status: 'negotiating', rate_amount_cents: 140000, deliverables: '1 dedicated video', due_date: daysFromNow(14), created_at: daysAgo(8) },
    { brand_name: 'Crestline Cameras', contact_name: 'Ben Ortiz', contact_email: 'ben@crestlinecam.com', status: 'negotiating', rate_amount_cents: 260000, deliverables: '1 video + gear loan', notes: 'Long-term ambassador conversation attached to this one.', due_date: daysFromNow(20), created_at: daysAgo(14) },
    { brand_name: 'Glowlab Cosmetics', contact_name: 'Tessa Moore', contact_email: 'tessa@glowlab.com', status: 'contracted', rate_amount_cents: 130000, deliverables: '1 integration', notes: 'Contract signed, filming scheduled next week.', due_date: daysFromNow(7), created_at: daysAgo(18) },
    { brand_name: 'Ripple Water Bottles', contact_name: 'Owen Clarke', contact_email: 'owen@ripplebottle.com', status: 'contracted', rate_amount_cents: 70000, deliverables: '2 Shorts', due_date: daysFromNow(5), created_at: daysAgo(15) },
    { brand_name: 'Anchor Financial App', contact_name: 'Nina Patel', contact_email: 'nina@anchorapp.com', status: 'contracted', rate_amount_cents: 300000, deliverables: '1 video + newsletter mention', notes: 'Highest-value deal this quarter.', due_date: daysFromNow(10), created_at: daysAgo(20) },
    { brand_name: 'Cedar & Sage', contact_name: 'Liam Foster', contact_email: 'liam@cedarandsage.com', status: 'delivered', rate_amount_cents: 90000, deliverables: '1 dedicated video', notes: 'Video published, invoice sent.', due_date: daysAgoDate(3), created_at: daysAgo(30) },
    { brand_name: 'Solace Sleep Co.', contact_name: 'Grace Wu', contact_email: 'grace@solacesleep.com', status: 'delivered', rate_amount_cents: 110000, deliverables: '1 video + 1 Short', notes: 'Waiting on payment, due in 5 days.', due_date: daysAgoDate(1), created_at: daysAgo(25) },
    { brand_name: 'Nordfeld Outdoor', contact_name: 'Erik Solberg', contact_email: 'erik@nordfeldoutdoor.com', status: 'paid', rate_amount_cents: 175000, deliverables: '1 video', notes: 'Paid on time, would work with again.', due_date: daysAgoDate(20), created_at: daysAgo(60) },
    { brand_name: 'PulseFit Nutrition', contact_name: 'Maya Alvarez', contact_email: 'maya@pulsefitnutrition.com', status: 'paid', rate_amount_cents: 85000, deliverables: '1 Short + 1 Story', due_date: daysAgoDate(35), created_at: daysAgo(70) },
    { brand_name: 'Brightside Coffee', contact_name: 'Tom Bradley', contact_email: 'tom@brightsidecoffee.com', status: 'paid', rate_amount_cents: 65000, deliverables: '1 integration', notes: 'Recurring partner — third deal with them.', due_date: daysAgoDate(50), created_at: daysAgo(90) },
  ]
  await supabase.from('deals').insert(deals.map((d) => ({ user_id: userId, ...d })))
